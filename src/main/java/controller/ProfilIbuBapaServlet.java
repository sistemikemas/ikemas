...
@WebServlet("/ProfilIbuBapaServlet")
public class ProfilIbuBapaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("jsp/profil_ibubapa.jsp").forward(request, response);
    }
